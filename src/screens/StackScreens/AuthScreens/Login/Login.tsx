...
const Login: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  //  API / Redux logic (temporarily disabled)
  ...
  const handleContinue = async () => {
    /**
     *  LOGIN API FLOW (COMMENTED FOR NOW)
     *
     * if (contact.length !== 10 || password.length < 4) {
     *   showMessage({
     *     message: "Please enter valid broker credentials",
     *     type: "danger",
     *   });
     *   return;
     * }
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>Welcome Broker 👋</Text>
          <Text style={styles.subtitle}>
            Login to manage your orders, partners & earnings
          </Text>
